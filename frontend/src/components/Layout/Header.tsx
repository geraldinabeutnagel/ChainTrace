...
const Header: React.FC = () => {
  ...
  const notifications = [
    {
      id: 1,
      title: 'New batch verified',
      message: 'Batch BATCH001 has been successfully verified',
    ...
    },
    {
      ...
      message: 'Temperature exceeded threshold in Warehouse A',
    ...
    },
    {
      ...
      message: 'Smartphone Model X has been registered',
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative"
              >
